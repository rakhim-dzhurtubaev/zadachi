...
public class  Main{
    ...
    public static void main(String[] args) {
        ...
        System.out.println("№1.Введите число для проверки на четность:");
        ...
        System.out.println("№4.Введите число N для суммы чисел от 1 до N:");
        ...
        System.out.println("№5.Введите число N для чисел Фибоначчи:");
        N = scanner.nextInt();
        int[] fib = new int[N];
        fib[0] = 0;
        if (N > 1) {
        ...
        System.out.println("№6.Введите число для проверки на простоту:");
        ...
        System.out.println("№7.Введите число N для вывода чисел от N до 1:");
        N = scanner.nextInt();
        ...
        System.out.println("№8.Введите два числа A и B для нахождения суммы четных чисел:");
        int A = scanner.nextInt();
        int B = scanner.nextInt();
        sum = 0;
        for (int i = A; i <= B; i++) {
        ...
        System.out.println("№9.Введите строку для реверса:");
        ...
        // Задача 13: Палиндром
        System.out.println("№13.Введите строку для проверки на палиндром:");
        ...
        System.out.println("№14.Введите размер массива:");
        ...
        System.out.println("№15.Сумма всех элементов массива: " + sum);
        ...
        System.out.println("№16.Количество положительных чисел: " + positiveCount);
        System.out.println("Количество отрицательных чисел: " + negativeCount);

        // Задача 17: Простые числа в диапазоне
        System.out.println("№17.Введите два числа A и B для поиска простых чисел в диапазоне:");
        A = scanner.nextInt();
        B = scanner.nextInt();
        ...
        System.out.println("№18.Введите строку для подсчета гласных и согласных:");
        str = scanner.nextLine();
        int vowelCount = 0;
        ...
        System.out.println("№19.Введите строку, состоящую из нескольких слов:");
        str = scanner.nextLine();
        ...
        System.out.println("№20.Введите число для проверки на число Армстронга:");
        number = scanner.nextInt();
